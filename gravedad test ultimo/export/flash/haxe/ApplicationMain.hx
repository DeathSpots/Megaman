...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/Mega-level1.oel");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/data/MegamanTrue.oep");
		types.push (lime.Assets.AssetType.TEXT);
		...
		urls.push ("assets/images/MegaTiles.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/pixel_heart_by_zetype-d8hctv1.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/RedMajumpsheetn.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/ZR-SHEET.png");
		types.push (lime.Assets.AssetType.IMAGE);

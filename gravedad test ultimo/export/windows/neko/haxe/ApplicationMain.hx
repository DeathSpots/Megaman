...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "gravedad test", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "gravedad test";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "gravedad test", null, { width: 640, height: 480 });
